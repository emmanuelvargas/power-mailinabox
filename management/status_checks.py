...
def get_latest_miab_version():
    ...
    try:
        return re.search(b'TAG=(.*)', urlopen("https://raw.githubusercontent.com/emmanuelvargas/power-mailinabox/master/setup/bootstrap.sh", timeout=5).read()).group(1).decode("utf8")
